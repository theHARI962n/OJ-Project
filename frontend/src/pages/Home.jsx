              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Write, compile and run C++ code with instant output and feedback.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Separate dashboards and access control for users and administrators.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Smart hint generation and error analysis to help you debug and learn faster.
                  </p>
                </motion.div>
              </motion.div>
            </div>
          ...
          >
            <div className="max-w-4xl mx-auto px-4 text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                ...
                and educators. Built with passion to learn, and this is a personal project that I have built. It brings
                together powerful features like real-time C++ compilation, question management, and future-ready AI assistance.
              </p>
            </div>
          </motion.section>
